...
function Character-Selection()
{
    ...
    Write-Host "                                                                                                              "   
    Write-Host "                                               A: Slorvak the Warrior                                         "
    Write-Host "                                               B: Prince Valant the Champion                                  "
    Write-Host "                                               C: Zanthe the Zombie                                           "
    Write-Host "                                               D: Amara the Wizard                                            "
    Write-Host "                                               E: Kindall the Innocent Child                                            "
    Write-Host "                                               F: D'Leeta the Queen of Enchantment                                           "
    Write-Host "                                               G: Tamika the Joker                                            "
    Write-Host "                                                                                                              "
    Write-Host "                     #####################################################################                    "
    Write-Host "                                                                                                              "
    ...
    Switch ($userResponse) 
    { 
            A {$global:playerCharacter = "Slorvak" ;$global:playerRole = "Warrior"}
            B {$global:playerCharacter = "Prince Valant" ;$global:playerRole = "Champion"} 
            C {$global:playerCharacter = "Zanthe" ;$global:playerRole = "Zombie"} 
            D {$global:playerCharacter = "Amara" ;$global:playerRole = "Wizard"} 
            E {$global:playerCharacter = "Kindall" ;$global:playerRole = "Innocent Child"}
            F {$global:playerCharacter = "D'Leeta" ;$global:playerRole = "Queen of Enchantment"}
            G {$global:playerCharacter = "Tamika" ;$global:playerRole = "Joker"}
            default {$global:playerCharacter = "Slorvak"}
    }

    Write-Host "                                     You selected $global:playerCharacter the $global:playerRole, lets begin"
...
function Attack-DragonOnOwnWarrior()
{
    Clear-Host
    ...
    Write-Host "You get close to the cave but cant see any sign of FireWing so you move close still."
    Write-Host ""
    Write-Host "Suddenly you stumble on FireWing in a dark cave and you SLAY him with your sword!"
    Write-Host ""
    Write-Host "Press any key to continue"    
